...
:END:
How to use [[https://www.terraform.io/][Terraform]], an infrastructure as code (IaC) tool, to automate creation and configuration of a [[https://www.digitalocean.com/][Digital Ocean]] droplet.
